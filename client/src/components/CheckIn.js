...
const CheckIn = () => {
  ...
  const providedLocation = useSelector(
    (state) => state.person.value.providedLocation
  );
    ...
    <>
      ...
      success ? (
        <div className="Success-Section">
          <Navbar />
          {/* <div className="logo-div-sub" style={{ position: 'absolute', top: '10px', left: '10px' }}>
          ...
          <section className="checkin-success">
            ...
            <h6>
              We are relieved to hear you are safe. Checking in will help your
              loved ones find that same relief.
            </h6>
            ...
            <h5>Last tracked location</h5>
            <h6>
               Keep in mind this location might not be
              accurate. We do our best to lock in correct location.
            </h6>
            <section className="data">
              <p>Country : {country}</p>
              <p>Region : {region}</p>
      ...
      <div className="form-bg">
          <h3 className="checkin-heading">Check in for your dear ones to know you are safe</h3>
          <form className="checkin" onSubmit={handleSubmit}>
            ...
            <input
              onChange={(e) =>
                dispatch(
                  setPersonLastName({ lastName: e.target.value.toUpperCase() })
                )
              }
            ...
            <input
              onChange={(e) =>
                dispatch(
                  setPersonProvidedLocation({
                    providedLocation: e.target.value.toUpperCase(),
                  })
                )
              }
            ...
            <input
              onChange={(e) =>
                dispatch(
                  setPersonFamily({
                    familyMember: e.target.value.toUpperCase(),
                  })
                )
              }
