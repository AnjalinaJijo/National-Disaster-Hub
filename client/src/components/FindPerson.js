...
const FindPerson = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios
      .post(LOGIN_URL, JSON.stringify({ firstName, lastName }), {
      ...
      {error ? (
        ...
        <div className="founddetails">
          <div className="found">
            ...
            <div>
              <p>
                First Name : <p className="info">{firstName}</p>
              </p>
            </div>
            <div>
              <p>
                Last Name : <p className="info">{lastName}</p>
              </p>
            </div>
            <div>
              <p>
                Home Town : <p className="info">{providedLocation}</p>
              </p>
            </div>
            <div>
              <p>
                Family Member : <p className="info">{familyMember}</p>
              </p>
            </div>
            <div>
              <p>
            ...
            <div>
              <p>
                Location : <p className="info">{loc}</p>{" "}
              </p>
            </div>
          </div>
        </div>
        ...
        <h1 className="logo-sub">N   D   H <p className='logo-txt'>National Disaster Hub</p></h1>
          ...
          <form className="find">
            <h1>Find</h1>
            <h5>Let's find if your loved ones are safe</h5>
            <input
              onChange={(e) => {
                dispatch(
                  setPersonFirstName({
